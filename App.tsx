...
import FactDuplicateGenerator from './components/FactDuplicateGenerator';
...
type Page = 'ttsGenerator' | 'imageGenerator' | 'veoCrafter' | 'googleFlow' | 'characterGenerator' | 'adminPanel' | 'animationGenerator' | 'videoSceneCreator' | 'factDuplicateGenerator';
...
const App: React.FC = () => {
    ...
    const [page, setPage] = useState<Page>(() => {
        ...
        // Fallback to 'ttsGenerator' if the saved page is one of the removed ones or not found
        const validPages: Page[] = ['ttsGenerator', 'imageGenerator', 'veoCrafter', 'googleFlow', 'characterGenerator', 'adminPanel', 'animationGenerator', 'videoSceneCreator', 'factDuplicateGenerator'];
    ...
    const menuItems = [
        ...
        { id: 'factDuplicateGenerator', label: 'Fakta & Duplikat Konten', icon: Lightbulb, desc: 'Gemini Konten' },
                ...
                <div className="h-20 flex items-center px-6 border-b border-gray-800 bg-[#161922]">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="text-[10px] text-gray-500 font-mono tracking-widest uppercase">Generator V5.0</span>
                        </div>
                    </div>
                    <button 
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden bg-gray-100/50">
                ...
                <div className={`flex-1 overflow-y-auto p-4 sm:p-6 lg:p-10 scroll-smooth`}>
                    <div className={`max-w-7xl mx-auto min-h-full`}>
                        ...
                        <div className={`animate-in fade-in zoom-in-95 duration-300 ${page === 'factDuplicateGenerator' ? 'block' : 'hidden'}`}>
                            <FactDuplicateGenerator />
                        </div>
